...
\end{tabular}
\caption{Summary of the $30$ different velocity divergence fields. The Field type describes whether the field comes from the Abacus Simulations (N-body) or it is generated from the power spectrum (Gaussian). $v_max$ only applies to the N-body fields and refers to the minimum value in the haloes' maximum circular velocity to be included in the peculiar velocity field interpolation.
