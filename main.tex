...
For instance the divergence has already been used in CosmicFlows-2 reconstruction data to define cosmic web elements \cite. 
...
One could also use divergence based superclusters to find their relationship with segmentation based on graphs built on top of the galaxy spatial distribution.
