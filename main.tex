...
This linear scaling relation clearly depends on the definition used in Equation \ref{eq:autocorrelation}. 
Using values smaller than $1/10$ in that definition have the consequence of breaking the linear scaling above $R_{\delta\delta}\approx 40$\Mpch for N-body fields. 
