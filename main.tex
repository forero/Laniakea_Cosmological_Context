...
This linear scaling relation with $\alpha\approx 1$ clearly depends on the definition used in Equation \ref{eq:autocorrelation}. 
...
Using values smaller than $1/10$ has two consequences.
First, it probes the region where the autocorrelation might oscillate, making ambiguous the autocorrelation length definition.
Second, also breaks the linearity of the scaling relation.
